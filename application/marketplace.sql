...
--
-- Host: localhost
-- Generation Time: Dec 17, 2018 at 09:27 PM
...
--
CREATE DATABASE IF NOT EXISTS `marketplace` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `marketplace`;
...
--
-- Table structure for table `client_commande_effectuer`
--
...
--
-- Dumping data for table `client_commande_effectuer`
--
...
--
-- Table structure for table `client_donner_avis`
--
...
--
-- Table structure for table `code_reduction`
--
...
--
-- Table structure for table `code_reduction_ligne_commande_appliquer`
--
...
--
-- Table structure for table `code_reduction_produit_variante_concerner`
--
...
--
-- Table structure for table `commercant_commerce_gerer`
--
...
--
-- Table structure for table `produit_type_caracteristique`
--
...
--
-- Table structure for table `produit_variante`
--
...
--
-- Dumping data for table `produit_variante`
--
...
--
-- Table structure for table `produit_variante_caracteristique`
--
...
--
-- Indexes for table `code_reduction_produit_variante_concerner`
--
...
--
-- Indexes for table `commercant_commerce_gerer`
--
...
--
-- Indexes for table `produit_type_caracteristique`
--
...
--
-- AUTO_INCREMENT for table `code_reduction`
--
ALTER TABLE `code_reduction`
...
--
-- AUTO_INCREMENT for table `produit_type`
--
ALTER TABLE `produit_type`
MODIFY `idProduitType` int(8) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=38;
--
-- AUTO_INCREMENT for table `produit_variante`
--
ALTER TABLE `produit_variante`
...
--
-- Constraints for table `client_commande_effectuer`
--
ALTER TABLE `client_commande_effectuer`
...
--
-- Constraints for table `client_donner_avis`
--
ALTER TABLE `client_donner_avis`
...
--
-- Constraints for table `code_reduction_ligne_commande_appliquer`
--
ALTER TABLE `code_reduction_ligne_commande_appliquer`
...
--
-- Constraints for table `code_reduction_produit_variante_concerner`
--
ALTER TABLE `code_reduction_produit_variante_concerner`
...
--
-- Constraints for table `commercant_commerce_gerer`
--
ALTER TABLE `commercant_commerce_gerer`
...
--
-- Constraints for table `produit_type`
--
ALTER TABLE `produit_type`
...
--
-- Constraints for table `produit_type_caracteristique`
--
ALTER TABLE `produit_type_caracteristique`
...
--
-- Constraints for table `produit_variante`
--
ALTER TABLE `produit_variante`
...
--
-- Constraints for table `produit_variante_caracteristique`
--
ALTER TABLE `produit_variante_caracteristique`
